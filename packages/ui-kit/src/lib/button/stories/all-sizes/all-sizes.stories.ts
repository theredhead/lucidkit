...
import { AllSizesStorySource } from "./all-sizes.story";
...
const meta = {
  ...
  decorators: [moduleMetadata({ imports: [AllSizesStorySource] })],
...
export const AllSizes: Story = {
  ...
  render: () => ({
    template: "<ui-all-sizes-story-demo />",
  }),
};
