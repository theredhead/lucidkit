...
import { MapViewPolygonDemo } from "./polygon-region.story";

const meta = {
  title: "@theredhead/UI Kit/Map View",
  component: MapViewPolygonDemo,
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
    docs: {
...
} satisfies Meta<MapViewPolygonDemo>;

export default meta;
type Story = StoryObj<MapViewPolygonDemo>;
...
export const PolygonRegion: Story = {
  ...
  render: () => ({
    template: "<ui-map-view-polygon-demo />",
  }),
};
