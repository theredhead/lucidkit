...
import { MapViewToggleHighlightDemo } from "./toggle-highlight.story";

const meta = {
  title: "@theredhead/UI Kit/Map View",
  component: MapViewToggleHighlightDemo,
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
    docs: {
...
} satisfies Meta<MapViewToggleHighlightDemo>;

export default meta;
type Story = StoryObj<MapViewToggleHighlightDemo>;
...
export const ToggleHighlight: Story = {
  ...
  render: () => ({
    template: "<ui-map-view-toggle-highlight-demo />",
  }),
};
