...
@Component({
  ...
  template: `
    <ui-source-tabs
      [tabs]="tabs"
      ariaLabel="JSONPlaceholder Posts source code"
    />
  `,
})
class UITableViewSourceTabsDemo {
...
export const JsonPlaceholderPostsSourceTabs: Story = {
  decorators: [
    moduleMetadata({
      imports: [UITableViewSourceTabsDemo],
    }),
  ],
  render: () => ({
    template: `<ui-table-view-source-tabs-demo />`,
    props: {},
  }),
  parameters: {
    docs: {
