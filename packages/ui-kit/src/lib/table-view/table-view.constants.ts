...
/** Width (px) of the leading row-index indicator column. Must match `--ui-row-index-width`. */
export const ROW_INDEX_COLUMN_WIDTH = 68;

/** Default virtual-scroll row height (px). */
export const DEFAULT_ROW_HEIGHT = 36;

/** Width (px) of the selection column (radio / checkbox). Must match `--ui-selection-col-width`. */
