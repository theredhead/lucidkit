...
const meta = {
  ...
  component: DemoAutogenerateEmployeesCityComponent,
  tags: ["autodocs"],
  parameters: {
    docs: {
      description: {
...
} satisfies Meta<DemoAutogenerateEmployeesCityComponent>;

export default meta;
type Story = StoryObj<DemoAutogenerateEmployeesCityComponent>;
