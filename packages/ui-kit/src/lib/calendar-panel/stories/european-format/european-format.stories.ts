...
import { EuropeanFormatStorySource } from "./european-format.story";
...
const meta = {
  ...
  decorators: [moduleMetadata({ imports: [EuropeanFormatStorySource] })]
} satisfies Meta;
...
export const EuropeanFormat: Story = {
  ...
  render: () => ({
      template: "<ui-european-format-story-demo />",
    })
};
