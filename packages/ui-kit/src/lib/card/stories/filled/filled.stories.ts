...
import { UICardStoryFilled } from "./filled.story";

const meta = {
  title: "@theredhead/UI Kit/Card",
  component: UICardStoryFilled,
  tags: ["autodocs"],
  parameters: {
    docs: {
      description: {
  ...
  decorators: [moduleMetadata({ imports: [UICardStoryFilled] })],
} satisfies Meta<UICardStoryFilled>;
