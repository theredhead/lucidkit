...
@Component({
  ...
  host: {
    ...
    "[class.top]": "resolvedTabPosition() === 'top'",
    "[class.bottom]": "resolvedTabPosition() === 'bottom'",
    "[class.left]": "resolvedTabPosition() === 'left'",
    "[class.right]": "resolvedTabPosition() === 'right'",
    "[class.flat]": "resolvedPanelStyle() === 'flat'",
    "[class.outline]": "resolvedPanelStyle() === 'outline'",
    "[class.raised]": "resolvedPanelStyle() === 'raised'",
    "[class.align-start]": "tabAlign() === 'start'",
    "[class.align-center]": "tabAlign() === 'center'",
    "[class.align-end]": "tabAlign() === 'end'",
  },
})
