...
@Component({
  ...
  changeDetection: ChangeDetectionStrategy.OnPush,
  imports: [UIButton],
  styleUrl: "./service-forced-choice.story.scss",
  templateUrl: "./service-forced-choice.story.html",
})
export class ServiceForcedDemo {
