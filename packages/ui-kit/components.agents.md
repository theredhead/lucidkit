...
| `UITableView`          | `src/lib/table-view/table-view.component.ts`                          | `ui-table-view`           | Virtual-scrolling table with sorting, filtering, selection, and column resizing                                       |
...
| `UITableBody`          | `src/lib/table-view/table-view-body/table-view-body.component.ts`     | `ui-table-body`           | Table body viewport with virtual scrolling (internal)                                                                 |
...
| `UISidebarHeader`      | `src/lib/sidebar-nav/sidebar-nav.component.ts`                        | `ui-sidebar-header`       | Sidebar header section                                                                                                |
| `UISidebarFooter`      | `src/lib/sidebar-nav/sidebar-nav.component.ts`                        | `ui-sidebar-footer`       | Sidebar footer section                                                                                                |
