...
describe('UIWizard', () => {
  ...
  describe('step indicator', () => {
    ...
    it('should mark the active step', () => {
      const indicators = wizardEl.querySelectorAll('.wizard-step-indicator');
      expect(indicators[0].classList.contains('wizard-step-indicator--active')).toBe(true);
      expect(indicators[1].classList.contains('wizard-step-indicator--active')).toBe(false);
    });
  ...
  describe('navigation', () => {
    it('should show Next button on first step', () => {
      const nextBtn = wizardEl.querySelector('.wizard-nav-button--next') as HTMLButtonElement;
    ...
    it('should go back on Back click', () => {
      ...
      const backBtn = wizardEl.querySelector('.wizard-nav-button--back') as HTMLButtonElement;
      backBtn.click();
      fixture.detectChanges();
  ...
  describe('step indicator state', () => {
    ...
    it('should mark completed steps with --completed class', () => {
      ...
      const indicators = wizardEl.querySelectorAll('.wizard-step-indicator');
      expect(indicators[0].classList.contains('wizard-step-indicator--completed')).toBe(true);
    });
    ...
    it('should mark completed connectors', () => {
      ...
      const connectors = wizardEl.querySelectorAll('.wizard-connector');
      expect(connectors[0].classList.contains('wizard-connector--completed')).toBe(true);
    });
  });
