...
import { FilterCollapsedDemo } from "./filter-mode-locked-closed.story";
...
const meta = {
  ...
  decorators: [moduleMetadata({ imports: [FilterCollapsedDemo] })]
} satisfies Meta;
...
export const FilterModeLockedClosed: Story = {
  ...
  render: () => ({
      template: "<ui-mdv-filter-collapsed-demo />",
    })
};
