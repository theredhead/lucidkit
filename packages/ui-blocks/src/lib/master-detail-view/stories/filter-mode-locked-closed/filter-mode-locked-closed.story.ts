...
import { FilterableArrayDatasource, UIAvatar, UITemplateColumn } from "@theredhead/lucid-kit";
...
@Component({
  ...
  styleUrl: "./filter-mode-locked-closed.story.scss",
  templateUrl: "./filter-mode-locked-closed.story.html",
})
export class FilterCollapsedDemo {
