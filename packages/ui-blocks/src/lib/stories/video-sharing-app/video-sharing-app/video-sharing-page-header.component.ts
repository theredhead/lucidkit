...
@Component({
  selector: "ui-video-sharing-page-header",
  standalone: true,
  imports: [UIBadge, UIIcon],
  changeDetection: ChangeDetectionStrategy.OnPush,
  templateUrl: "./video-sharing-page-header.component.html",
  styleUrl: "./video-sharing-page-header.component.scss",
})
export class UIVideoSharingPageHeader {
  /**
