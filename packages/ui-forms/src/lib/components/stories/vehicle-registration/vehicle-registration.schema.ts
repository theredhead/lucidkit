...
/**
 * Shared vehicle registration demo schema used by both the UIForm story
 * and the UIFormDesigner story.
 */
export const VEHICLE_REGISTRATION_SCHEMA: FormSchema = {
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          component: "signature",
          description:
            "Sign above to confirm that all information provided is accurate and complete.",
          validation: [
            {
              type: "required",
              message: "Signature is required to submit the application.",
            },
          ],
        },
      ],
