...
import { VehicleRegistrationStorySource } from "./vehicle-registration.story";
...
const meta = {
  ...
  decorators: [moduleMetadata({ imports: [VehicleRegistrationStorySource] })]
} satisfies Meta;
...
export const VehicleRegistration: Story = {
  ...
  render: () => ({
      template: "<ui-vehicle-registration-story-demo />",
    })
};
