...
import { WithoutSubmitButtonStorySource } from "./without-submit-button.story";
...
const meta = {
  ...
  decorators: [moduleMetadata({ imports: [WithoutSubmitButtonStorySource] })]
} satisfies Meta;
...
export const WithoutSubmitButton: Story = {
  ...
  render: () => ({
      template: "<ui-without-submit-button-story-demo />",
    })
};
