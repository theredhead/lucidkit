...
import { ValidationDemoStorySource } from "./validation-demo.story";
...
const meta = {
  ...
  decorators: [moduleMetadata({ imports: [ValidationDemoStorySource] })]
} satisfies Meta;
...
export const ValidationDemo: Story = {
  ...
  render: () => ({
      template: "<ui-validation-demo-story-demo />",
    })
};
